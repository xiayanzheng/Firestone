...
docker run -d -p 9090:9090 --network rms-network --name $container_name -v /root/lfdata/promdata/conf/prometheus.yml:/opt/bitnami/prometheus/conf/prometheus.yml bitnami/prometheus:latest